...
- (UIButton *)leftBtn {
    if (!_leftBtn) {
        ...
        _leftBtn.layer.borderColor = [UIColor colorWithRed:165.0/255.0  green:165.0/255.0  blue:167.0/255.0 alpha:1.0].CGColor;
        _leftBtn.layer.borderWidth = 1.0f;
        _leftBtn.layer.masksToBounds = YES;
        _leftBtn.titleLabel.font = [UIFont systemFontOfSize:15.0f];
        [_leftBtn setTitleColor:[UIColor colorWithRed:150.0/255.0  green:150.0/255.0  blue:150.0/255.0 alpha:1.0] forState:UIControlStateNormal];
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        _rightBtn.backgroundColor = [UIColor colorWithRed:203.0/255.0  green:179.0/255.0  blue:109.0/255.0 alpha:1.0];
