...
-(void)creatsubViewswithArr:(NSArray *)btnArr type:(NSInteger)type titleName:(NSString *)titleName{    FMHouseMesCM *mesModel = btnArr[0];
//    if (mesModel.selectType==1&&mesModel.selectType==2) {
//        <#statements#>
//    }
